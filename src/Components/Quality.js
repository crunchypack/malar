...
class Quality extends React.Component {
  render() {
    let text ="Målaresset i Göteborg är ett kvalitets- och miljömedvetet företag som alltid har kunden i fokus. Vi strävar efter att alltid välja de produkter som har minst negativ miljöpåverkan. I samråd med beställare, kunder och våra samarbetspartner väljer vi alltid det alternativet som är bäst ur miljö- och hälsoperspektivet. Valda produkter skall ge en försköning och lång livslängd åt den behandlade ytan. Vi arbetar med professionella svanenmärkta produkter som är miljö- och hälsocertifierade, det betyder att målarfärgen är vattenburen och innehåller inga allergiframkallande eller hormonstörande ämnen.";
